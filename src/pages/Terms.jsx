  ...
  return (
    <div className="container mx-auto p-8">
      <Helmet>
        ...
        <meta name="description" content="Read the Terms of Service for EasyGIFMaker. Understand your rights and responsibilities when using our GIF and video editing tools." />
      ...
      <p className="mb-2">By using EasyGIFMaker, you agree to use the service for lawful purposes only. We reserve the right to update these terms at any time.</p>
