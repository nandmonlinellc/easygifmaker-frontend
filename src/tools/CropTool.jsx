        ...
        <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl p-8 border border-blue-100">
          <div className="text-center mb-8">
            <div className="flex justify-center items-center gap-4 mb-4">
              <Crop size={40} className="text-blue-600 drop-shadow" />
              <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 drop-shadow-sm tracking-tight">
                Crop GIF
              </h1>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Crop GIFs online for free. Trim, cut, and resize GIFs with precision. Custom dimensions and aspect ratios. Perfect for social media and web use.
            </p>
          </div>
          {/* Upload State */}
